...
describe 'NIST P-192 examples' do
  ...
  let(:e) { ['1B376F0B735C615CEEEB31BAEE654B0A374825DB'].pack('H*') }
...
describe 'NIST P-224 examples' do
  ...
  let(:e) { ['1F1E1CF892926CFCCFC5A28FEEF3D807D23F778008DBA4B35F04B2FD'].pack('H*') }
...
describe 'NIST P-256 examples' do
  ...
  let(:e) { ['A41A41A12A799548211C410C65D8133AFDE34D28BDD542E4B680CF2899C8A8C4'].pack('H*') }
...
describe 'NIST P-384 examples' do
  ...
  let :e do
    ['5AEA187D1C4F6E1B35057D20126D836C6ADBBC7049EE0299C9529F5E0B3F8B5A7411149D6C30D6CB2B8AF70E0A781E89'].pack('H*')
  end
...
describe 'NIST P-521 examples' do
  ...
  let :e  do
    ['9BF0E1DEEDA31E00F925B77F7CB6B1CED7368DE1DC75BB9F94582C1CA709205D32AF90025B02FA132FBEBD6CDDCD9172C0D66D8E581767A8B6F71DE60BE1F932'].pack('H*')
  end
